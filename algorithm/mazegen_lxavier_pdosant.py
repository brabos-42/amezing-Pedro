...
class MazeGenerator(Cell):
    ...
    The maze is internally represented as a grid where:
        1   -> wall
        0   -> carved path
    ...
    def create_maze(self):
        ...
        """
        maze = [[0.0 for _ in range(self.width)] for _ in range(self.height)]
    ...
    def generate_final_maze(self, wall_color=None):
        """
